...
export const APP_CATALOG: AppItem[] = [
  ...
  { id: 'project', name: 'Project', desc: '프로젝트 관리 · 태스크 · 칸반', base: 'Odoo Project', engine: 'erpengine', icon: 'taskView', category: 'productivity', phase: 2, subdomain: 'project', containers: ['polyon-erpengine'], requires: ['sso'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '프로젝트·태스크 관리. 칸반 보드, 마일스톤, 데드라인 추적.', actions: [] },
  { id: 'survey', name: 'Survey', desc: '설문 · 양식 · 만족도 조사', base: 'Odoo Survey', engine: 'erpengine', icon: 'list', category: 'productivity', phase: 2, subdomain: 'survey', containers: ['polyon-erpengine'], requires: ['sso'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '설문·양식 빌더. 직원 설문, 채용 시험, 고객 만족도 조사.', actions: [] },
  /* ══ Business ══ */
  { id: 'hr', name: 'HR', desc: '인사 관리 · 조직도 · 근태 · 휴가', base: 'Odoo HR', engine: 'erpengine', icon: 'userMultiple', category: 'business', phase: 1, subdomain: 'hr', containers: ['polyon-erpengine'], requires: ['sso'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '인사 관리 시스템. 직원 정보, 조직도, 근태, 휴가 신청/승인, 인사평가.', actions: [] },
  { id: 'crm', name: 'CRM', desc: '고객 관리 · 영업 파이프라인', base: 'Odoo CRM', engine: 'erpengine', icon: 'partnership', category: 'business', phase: 2, subdomain: 'crm', containers: ['polyon-erpengine'], requires: ['sso'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '고객·거래처 관리. 영업 파이프라인, 기회 추적, 미팅 일정, 매출 예측.', actions: [] },
  { id: 'recruitment', name: 'Recruitment', desc: '채용 관리 · 지원자 추적 · 면접', base: 'Odoo Recruitment', engine: 'erpengine', icon: 'userFollow', category: 'business', phase: 2, subdomain: null, containers: ['polyon-erpengine'], requires: ['sso', 'hr'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '채용 파이프라인 관리. 채용 공고, 지원자 추적, 면접 일정.', actions: [] },
  { id: 'timesheet', name: 'Timesheet', desc: '근무시간 기록 · 프로젝트별 공수', base: 'Odoo Timesheet', engine: 'erpengine', icon: 'time', category: 'business', phase: 2, subdomain: null, containers: ['polyon-erpengine'], requires: ['sso', 'hr', 'project'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '프로젝트·태스크별 근무시간 기록. HR 근태 + Project 연계.', actions: [] },
  { id: 'expense', name: 'Expense', desc: '경비 청구 · 영수증 · 정산', base: 'Odoo Expense', engine: 'erpengine', icon: 'receipt', category: 'business', phase: 2, subdomain: null, containers: ['polyon-erpengine'], requires: ['sso', 'hr'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '경비 청구·정산. 영수증 첨부, 승인 워크플로우.', actions: [] },
  { id: 'accounting', name: 'Accounting', desc: '회계 · 세금계산서 · 매입매출', base: 'Odoo Accounting', engine: 'erpengine', icon: 'calculator', category: 'business', phase: 3, subdomain: null, containers: ['polyon-erpengine'], requires: ['sso'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '복식부기 회계. 세금계산서 발행, 매입·매출 관리, 은행 연동, 재무제표.', actions: [] },
  { id: 'approval', name: 'Approval', desc: '전자 결재 · 워크플로우', base: 'Odoo Custom Module', engine: 'erpengine', icon: 'checkmark', category: 'business', phase: 3, subdomain: 'approval', containers: ['polyon-erpengine'], requires: ['sso'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '전자 결재 시스템. 결재 라인, 문서 첨부, 모바일 결재.', actions: [] },
  { id: 'helpdesk', name: 'Helpdesk', desc: '고객 지원 · 티켓 · SLA', base: 'Odoo Custom Module', engine: 'erpengine', icon: 'headset', category: 'business', phase: 3, subdomain: 'support', containers: ['polyon-erpengine'], requires: ['sso'], status: 'coming-soon', statusLabel: 'Coming Soon', details: '고객 지원 티켓 시스템. SLA 관리, 자동 배정, 지식베이스 연동.', actions: [] },
  /* ══ Intelligence ══ */
...
export const ENGINE_BADGES: Record<string, { label: string; color: string; fg?: string }> = {
  'erpengine':    { label: 'ERPEngine',    color: '#714B67' },
